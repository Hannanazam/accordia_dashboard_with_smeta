...
<body id="app-container" class="menu-default show-spinner">
    <nav class="navbar fixed-top">
        ...
        <a class="navbar-logo" href="Dashboard.Default.html">
            <span class="logo d-none d-xs-block"><img src="https://www.accordiausa.com/wp-content/uploads/2020/10/primarylogo.png" alt=""> </span>
        ...
        <div class="sub-menu">
            <div class="scroll">
                <ul class="list-unstyled" data-link="dashboard">
                    <li>
                        <a href="index.php">
                            <i class="simple-icon-rocket"></i> <span class="d-inline-block">Head Office</span>
                        </a>
                    </li>
                    <li>
                        <a href="audit.php">
                            <i class="simple-icon-rocket"></i> <span class="d-inline-block">Add New Client (SRS)</span>
                        </a>
                    </li>
                    <li>
                        <a href="smeta.php">
                            <i class="simple-icon-rocket"></i> <span class="d-inline-block">SMETA (SRS)</span>
                        </a>
                    </li>
                </ul>
